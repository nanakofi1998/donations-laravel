...
(function($) {
 ...
 var dzChartlist = function(){
	...
	var userDonationsChart = function(){
		 var options = {
          series: [{
          name: 'Total Donations (value)',
          type: 'column',
          data: [75, 85, 72, 100, 50, 100, 80, 75, 95, 35, 75,1000]
        }, {
       ...
       tooltip: {
        ...
        var chart = new ApexCharts(document.querySelector("#userDonationsChart"), options);
        chart.render();
	...
	var projectChart = function(){
       ...
       plotOptions: {
		 ...
		 colors: ['var(--primary)','#3AC977','#FF5E5E','#FF9F00',],
