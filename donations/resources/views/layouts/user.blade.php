            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="#" class="has-arrow" aria-expanded="false">
                            <div class="menu-icon">
                                <img src="{{ asset('assets/images/svg/crowdfunding.svg') }}" alt=""
                                    style="width:22px; height:22px;">
                            </div>
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            <div class="menu-icon">
                                <img src="{{ asset('assets/images/svg/settings.svg') }}" alt=""
                                    style="width:22px; height:22px;">
                            </div>
                            <span class="nav-text">Settings</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route ('auth_settings')}}">Auth</a></li>
                        </ul>
                    </li>
                     <li><a class="" href="{{route('user_calendar')}}" aria-expanded="false">
                            <div class="menu-icon">
                                <img src="{{ asset('assets/images/svg/calendar.svg') }}" alt=""
                                    style="width:22px; height:22px;">
                            </div>
                    ...
                    <li>
                        <a  href="{{route('account')}}" aria-expanded="false">
                            <div class="menu-icon">
